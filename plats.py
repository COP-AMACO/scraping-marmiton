PLATS = [
    ...
    "Bruschetta",
    "Rillettes de thon",
    "Gressins au jambon cru",
    "Blinis au saumon",
    "Mini brochettes tomates mozzarella",
    "Falafels",
    "Empanadas",
    "Mini croque-monsieur",
    "Mini burgers",
    "Oignons frits",
    "Tortilla roulée au fromage",
    "Beignets de crevettes",
    "Toasts tapenade et chèvre",
    "Saucisson sec",
    "Fromage en cubes",
    "Chips de légumes",
    "Nuggets de poulet",
    ...
    "Mini samoussas légumes",
    "Quesadillas coupées",
    "Sardines grillées sur toast",
    "Pain pita et dips",
    "Mini tartines nordiques",
    "Crostinis variés",
    "Crackers et fromage",
    "Mini tacos",
    "Patatas bravas",
    ...
    "Poulet au citron et quinoa",
    "Ratatouille",
    "Tajine de légumes",
    "Bibimbap sans sauce soja (ou avec tamari)",
    "Salade de lentilles",
    "Soupe de potiron au lait de coco",
    "Galettes de sarrasin aux champignons",
    "Poisson grillé et patates douces",
    "Boeuf sauté aux légumes",
    "Salade de quinoa et feta",
    "Omelette aux herbes",
    "Soupe miso sans miso d’orge",
    "Homard grillé au beurre citronné",
    "Risotto aux truffes",
    "Filet de bœuf Rossini",
    "Paella aux fruits de mer",
    "Tournedos de bœuf aux morilles",
    "Sushi au thon rouge et anguille",
    "Foie gras poêlé sur pain brioché",
    "Côte de veau aux girolles",
    ...
    "Polenta crémeuse",
    "Pâtes à l’huile d’olive et herbes",
    "Semoule de couscous",
    "Quinoa aux légumes",
    "Haricots verts à l’ail",
    "Pommes de terre grenaille",
    "Purée de patates douces",
    "Chou sauté à l’asiatique",
    "Épinards à la crème",
    "Galettes de légumes",
